## Welcome to my Code Book for the Getting and Cleaning Data Course Project!!!
##################################################################

For step 2 of the assignment, I restricted the variables only to those indicated by:
	mean(): Mean value
...
For each record  in the all database, it is provided:
======================================
